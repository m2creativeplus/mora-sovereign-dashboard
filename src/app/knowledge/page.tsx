      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 flex items-center justify-center">
           <div className="glass-card p-10 max-w-lg text-center">
              <BookOpen size={48} style={{ color: "#D4AF37", margin: "0 auto", opacity: 0.5 }} />
              <h3 className="font-outfit font-bold text-xl mt-6" style={{ color: "#E8EDE9" }}>MORA AI Assistant</h3>
              <p className="text-sm mt-3 leading-relaxed" style={{ color: "rgba(232,237,233,0.6)" }}>
                This module will introduce a retrieval-augmented generation (RAG) system for searching the entire catalog of Fatwas and policies in Somali, Arabic, and English.
              </p>
